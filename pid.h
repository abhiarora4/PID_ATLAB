...
//ROLL RATE PID
double p_rol_rate = 0.8;
double i_rol_rate = 0.01;
...
//PITCH RATE PID
double p_pitch_rate = 0.8;
double i_pitch_rate = 0.01;
...
double p_rol_angle = 0.5;
double i_rol_angle = 0.01;
...
double p_pitch_angle = 0.5;
double i_pitch_angle = 0.01;
